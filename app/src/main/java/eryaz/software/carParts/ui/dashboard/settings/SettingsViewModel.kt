package eryaz.software.carParts.ui.dashboard.settings

import android.content.Context
import androidx.lifecycle.asLiveData
import androidx.lifecycle.viewModelScope
import eryaz.software.carParts.BuildConfig
import eryaz.software.carParts.R
import eryaz.software.carParts.core.ApkDownloadService
...
import eryaz.software.carParts.data.models.dto.CurrentUserDto
...
class SettingsViewModel(
    ...
    fun startVersionService(context: Context) {

        ApkDownloadService.startService(
            context,
            _pdaVersionModel.value?.downloadLink,
            _pdaVersionModel.value?.apkZipName,
            _pdaVersionModel.value?.apkFileName
        )
    }
